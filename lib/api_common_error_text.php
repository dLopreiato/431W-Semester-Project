...
define('ERRTXT_DBCONN_FAILED', 'A connection error has occured. Contact the administrator.');
...
define('ERRTXT_UNSETVARIABLE', 'A fatal error has occured on this page. Contact the administrator.');

// error for when a query fails
define('ERRTXT_FAILED_QUERY', 'Something whent wrong with your request. Go back and try again. If you keep getting this error, contact the administrator.');

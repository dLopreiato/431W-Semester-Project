...
Process: Gets the user's seller info from the seller table
Output: Returns an associative array of the user's seller info (sends single error on failure)
*/
...
if($username === false) {
	...
	$query = "SELECT name, address, point_of_contact, phone FROM sellers WHERE username = '$username'";
